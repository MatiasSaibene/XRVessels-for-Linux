...
//#include "meshres.h"
#include "../DeltaGliderXR1/meshres.h"
...
void DeltaGliderXR1::SetXRAnimation(const unsigned int &anim, const double state) const
{
...
void DeltaGliderXR1::DefineAnimations()
{
    ...
    static unsigned int HoverDoorsFLGrp[1] = { GRP_frhovleft };           // Forward left door
    static MGROUP_ROTATE HoverDoorsFL (0, HoverDoorsFLGrp, 1,     
        _V(-0.60,-1.62,2.96), _V(0,0,1), -hoverDoorRotation);
    
    static unsigned int HoverDoorsFRGrp[1] = { GRP_frhovright };          // Forward right door
    static MGROUP_ROTATE HoverDoorsFR (0, HoverDoorsFRGrp, 1,     
        _V(0.60,-1.62,2.96), _V(0,0,1), hoverDoorRotation);

    static unsigned int HoverDoorsPLGrp[1] = { GRP_Lefthovleft };         // Port left door
    static MGROUP_ROTATE HoverDoorsPL (0, HoverDoorsPLGrp, 1,     
        _V(-3.57,-1.25,-4.75), _V(0,0,1), -hoverDoorRotation);

    static unsigned int HoverDoorsPRGrp[1] = { GRP_Lefthovright };        // Port right door
    static MGROUP_ROTATE HoverDoorsPR (0, HoverDoorsPRGrp, 1,     
        _V(-2.42,-1.25,-4.75), _V(0,0,1), hoverDoorRotation);

    static unsigned int HoverDoorsSLGrp[1] = { GRP_Righthovleft };        // Starboard left door
    static MGROUP_ROTATE HoverDoorsSL (0, HoverDoorsSLGrp, 1,     
        _V(2.42,-1.25,-4.75), _V(0,0,1), -hoverDoorRotation);

    static unsigned int HoverDoorsSRGrp[1] = { GRP_Righthovright };       // Starboard right door
    ...
    static unsigned int ScramDoorsGrp[1] = { GRP_scramclose };           // single SCRAM door mesh
    ...
    static unsigned int VCNConeTLGrp[1] = {106};
    static MGROUP_ROTATE VCNConeTL (1, VCNConeTLGrp, 1,
        _V(-0.424,-0.066,9.838), _V(-0.707,-0.707,0), static_cast<float>(150*RAD));
    static unsigned int VCNConeTRGrp[1] = {107};
    ...
    static unsigned int VCILockGrp[4] = {10,28,11,127};
    ...
    static unsigned int VCHatchGrp[1] = {14};
    ...
    static unsigned int VCRearLadderGrp[2] = {29,30};
    ...
    // ***** Elevator animation *****
    static unsigned int ElevatorGrp[8] = {29,30,35,36,51,52,54,55};
    ...
    // ***** Aileron animation *****
    static unsigned int LAileronGrp[4] = {29,30,51,52};
    ...
    static unsigned int RAileronGrp[4] = {35,36,54,55};
    ...
    static unsigned int MainThrottleLGrp[2] = {32,53};
    ...
    static unsigned int MainThrottleRGrp[2] = {37,54};
    ...
    static unsigned int HoverThrottleGrp[2] = {38,60};
    ...
    static unsigned int ScramThrottleLGrp[2] = {39,61};
    ...
    static unsigned int ScramThrottleRGrp[2] = {40,62};
    ...
    static unsigned int GearLeverGrp[2] = {42,63};
    ...
    static unsigned int NoseconeLeverGrp[2] = {43,64};
    ...
    static unsigned int ScramGimbalLGrp = 69;
    ...
    static unsigned int ScramGimbalRGrp = 70;
    ...
    static unsigned int PMainGimbalLGrp = 72;
    ...
    static unsigned int PMainGimbalRGrp = 73;
    ...
    static unsigned int YMainGimbalLGrp = 74;
    ...
    static unsigned int YMainGimbalRGrp = 75;
    ...
    static unsigned int HBalanceGrp = 68;
    ...
    static unsigned int HUDIntensGrp = 78;
    ...
    static unsigned int RCSDialGrp = 79;
    ...
    static unsigned int AFDialGrp = 83;
    ...
    static unsigned int OLockSwitchGrp = 90;
    ...
    static unsigned int ILockSwitchGrp = 93;
    ...
    static unsigned int RetroSwitchGrp = 95;
    ...
    static unsigned int LadderSwitchGrp = 96;
    ...
    static unsigned int HatchSwitchGrp = 97;
    ...
    static unsigned int RadiatorSwitchGrp = 98;
