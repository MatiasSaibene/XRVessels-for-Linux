...
// Constructor
XR5PayloadBay::XR5PayloadBay(VESSEL &parentVessel) :
    XR1PayloadBay(parentVessel)
{
    ...
    // NOTE: if you change this code you must update PAYLOAD_BAY_SLOT_COUNT in XR5Globals.cpp to match!
...
void XR5Vanguard::CreatePayloadBay()
{
    // create our payload bay
    m_pPayloadBay = new XR5PayloadBay(*this);
