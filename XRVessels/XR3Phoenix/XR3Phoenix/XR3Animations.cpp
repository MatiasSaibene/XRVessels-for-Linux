...
void XR3Phoenix::SetXRAnimation(const unsigned int &anim, const double state) const
{
...
// The code below that is #if'd out is a copy of the XR5's code for reference / template purposes
    ...
    //bottom
    static Uunsigned intINT gear_door_right_outside_2Grp[1] = {GRP_gear_door_right_outside_2,};
